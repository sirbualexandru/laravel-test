<aside id="left-panel">
    ...
    <nav>
        <ul>
            <li class="{{ isset($active_menu) && $active_menu == 'jobs' ? 'active' : '' }}">
                <a href="/jobs">
            ...
            @role('employer')
            <li class="{{ isset($active_menu) && $active_menu == 'categories' ? 'active' : '' }}">
                <a href="/categories">
            ...
            <li class="{{ isset($active_menu) && $active_menu == 'candidates' ? 'active' : '' }}">
                <a href="/candidates">
