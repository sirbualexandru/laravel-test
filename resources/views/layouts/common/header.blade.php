...
<html lang="en-us" class="smart-style-1">
	<head>
		...
		<!-- FAVICONS -->
		<!--link rel="shortcut icon" href="img/favicon/favicon.ico?p=1" type="image/x-icon">
		...
		@yield('custom_css')
		<link rel="stylesheet" href="{{url('css/your_style.css')}}">

        <!--link rel="stylesheet" href="/custom_plugins/bootstrap-fileinput/css/fileinput.min.css" -->
