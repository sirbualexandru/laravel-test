    ...
    <div id="main" role="main">
        ...
        <div id="ribbon">
            ...
            <ol class="breadcrumb">
                ...
                <li>{{ trans('lang.job') }} {{ trans('lang.categories') }}</li>
            </ol>
            <!-- end breadcrumb -->
        </div>
        <!-- END RIBBON -->
            ...
            <div class="row">
                <div class="col-xs-7 col-sm-5 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        {{ trans('lang.job') }} {{ trans('lang.categories') }}
                    </h1>
                </div>
                <div class="col-xs-5 col-sm-7 col-lg-4 padding-10">
                    <a href="#" ajax_target="/categories/create" class="btn btn-success pull-right remote_modal">
                        <i class="fa fa-list"></i> {{ trans('Create category') }}
                    </a>
                </div>
            </div>
                                ...
                                <div class="widget-body no-padding">
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th class="hasinput"style="width:135px">
                                                <input id="dateselect_filter"
                                                       type="text"
                                                       placeholder="{{ trans('Created at') }}"
                                                       class="form-control datepicker"
                                                       data-dateformat="{{config('leblanc.datepicker')}}"/>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th data-hide="phone,tablet">{{ trans('lang.name') }}</th>
                                            <th data-hide="phone,tablet" >{{ trans('Created at') }}</th>
...
@section('custom_script')
    <script>
        ...
        $(document).ready(function () {
            ...
            pagenumbner = (localStorage.getItem('CategoriesList')) ? localStorage.getItem('CategoriesList') : 0;
            /* BASIC ;*/
            ...
            $('#datatable_fixed_column').on('page.dt', function () {
                localStorage.setItem('CategoriesList', otable.page.info().page);
            });
            ...
            $(document).on('submit', '.remove-resource', function (e){
                ...
                $.SmartMessageBox({
                    ...
                    content : '{{ trans('Are you sure you want to remove this category?') }}',
                        ...
                        $.ajax({
                            ...
                            error: function(xhr){
                                $.smallBox({
                                    ...
                                    content : '<i class="fa fa-times"></i> <i>' + xhr.responseText + '</i>',
                                    color : '#C46A69',
